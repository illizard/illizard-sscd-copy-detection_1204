...
#이 함수는 주어진 쿼리 세트 xq와 레퍼런스 이미지 데이터베이스 xb에 대해 k-NN 검색을 수행하여 각 쿼리 이미지에 대한 가장 유사한 
#k개의 레퍼런스 이미지를 찾습니다. 결과는 PredictedMatch 객체의 리스트로 반환됩니다.#
def knn_match_and_make_predictions(
    ...
    return predictions # 시각화하려면 여기를 가져오면 됨 10장 쿼리 10장 레런스 gpu1장이면 [10, 10] 행렬이 됨
# predictions = [PredictedMatch(query....17397478), PredictedMatch(query....27378154), PredictedMatch(query...0.5327209), ...]
# 00:
# PredictedMatch(query='Q00003', db='R863161', score=-0.17397478)
# 01:
# PredictedMatch(query='Q00003', db='R487691', score=-0.27378154)
# 02:
# PredictedMatch(query='Q00003', db='R937849', score=-0.37989843)
# 03:
# PredictedMatch(query='Q00003', db='R557200', score=-0.44374394)
# 04:
# PredictedMatch(query='Q00003', db='R852827', score=-0.49271813)
# 05:
# PredictedMatch(query='Q00003', db='R277154', score=-0.50006604)
# 06:
# PredictedMatch(query='Q00003', db='R531761', score=-0.52980775)
# 07:
# PredictedMatch(query='Q00003', db='R246671', score=-0.53783953)
# knn에서 k가 10 이어서 10개까지 다 유사도 구함
